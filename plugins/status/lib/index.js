...
var EnvInfoProvider = class extends import_console.DataService {
  constructor(ctx, config) {
    super(ctx, "envinfo");
    this.config = config;
  }
  static {
    __name(this, "EnvInfoProvider");
  }
  task;
  async _get() {
...
// src/profile.ts
var TickCounter = class _TickCounter {
  static {
    __name(this, "TickCounter");
  }
  stop;
...
var ProfileProvider = class extends import_console2.DataService {
  constructor(ctx, config) {
    super(ctx, "status");
    this.config = config;
